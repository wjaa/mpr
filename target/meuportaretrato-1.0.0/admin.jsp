	  ...
	  <h2><span class="label label-info">${requestScope.msg}</span></h2>
		...
		<div class="tab-content">
  			...
  			<div class="tab-pane active" id="cadPr">
				  ...
				  <div class="form-group">
				    	<label for="inputExtensao" class="col-sm-2 control-label">Extensão:</label>
				    	<div class="col-sm-3">
				  		<select class="form-control" required autofocus name="extensao" id="extensao">
				  			<option>...</option>
				  			<option>JPG</option>
				  			<option>PNG</option>
				  			<option>GIF</option>
					  ...
					  <div class="form-group">
				  	 ...
				  	 <div>
						<table class="table table-hover">
							...
							<tbody>
								  <c:forEach var="pr" items="${requestScope.prConfig.prs}">	
